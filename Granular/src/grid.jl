...
"""
    fitGridToGrains!(simulation, grid[, west_padding, south_padding,
                        east_padding, north_padding])
...
* `west_padding::Real`: optional padding around edges [m].
* `south_padding::Real`: optional padding around edges [m].
* `east_padding::Real`: optional padding around edges [m].
* `north_padding::Real`: optional padding around edges [m].
* `verbose::Bool`: show grid information when function completes.
"""
function fitGridToGrains!(simulation::Simulation, grid::Any;
                          west_padding::Real=0.,
                          south_padding::Real=0.,
                          east_padding::Real=0.,
                          north_padding::Real=0.,
                          verbose::Bool=true)
