#This script should be run using pvpython
#pvpython for mac can be intalled using homebrew: 'brew install --cask paraview'
#run using 'pvpython (filename).py'

#todo:
# make an option to print text/description in the figure
...
#inputs:
#simnr = 'simulation40000'
#simid = 20

#rpath = '/init'
#path = simulationnr+rpath

#import the full range of simulation .vtu files..?
def importSimulation(simnr,simid,shearstrain):
